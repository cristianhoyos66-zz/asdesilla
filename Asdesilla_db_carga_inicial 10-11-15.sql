INSERT INTO tbl_tipo_cargo (IdTipoCargo, NombreTipoCargo) VALUES
(1, 'Administración'),
(2, 'Médico');

INSERT INTO tbl_tipo_documentos (IdTipoDoc, Nombre) VALUES
(1, 'CC'),
(2, 'TI'),
(3, 'CE'),
(4, 'Registro Civil'),
...
INSERT INTO tbl_tipo_remision (IdTipoRemision, NombreTipoRemision) VALUES
(1, 'Clínica'),
(2, 'EPS'),
(3, 'Médico Particular');

INSERT INTO tbl_tipo_terapias (IdTipoTerapia, Nombre) VALUES
(1, 'POS'),
(2, 'Alternativa');

INSERT INTO tbl_autoridad (IdPAutoridad, Nombre) VALUES
(1, 'Esposo(a)'),
(2, 'Padre'),
(3, 'Madre'),
(4, 'Hermano(a)'),
...
INSERT INTO tbl_cargo (IdCargo, NombreCargo, TipoCargo) VALUES
(1, 'Administrador', 1),
(2, 'Secretaria Fundación', 1),
(5, 'Terapeuta', 2),
(6, 'Fonoaudiólogo(a)', 2),
(7, 'Psicólogo(a)', 2);

INSERT INTO tbl_perfiles (IdPerfil, Nombre) VALUES
(1, 'Administrador'),
(2, 'Profesional Médico');

INSERT INTO tbl_terapias (IdTerapia, Nombre, Tipo) VALUES
(1, 'Fisioterapia', 1),
(2, 'Fonoaudiología', 1),
(3, 'Psicología', 1),
(4, 'Equinoterapia', 2),
(5, 'Educación Especial', 2);

INSERT INTO tbl_eps (IdEps, Nombre) VALUES
(1, 'Cafesalud'),
(2, 'Caprecom'),
(3, 'Colmedica'),
(4, 'Compensar'),
...
(9, 'Famisanar'),
(10, 'Humana Vivir'),
(11, 'Instituto de los Seguros Sociales'),
(12, 'Salud Colpatria'),
(13, 'Solsalud'),
(14, 'Servicio Occidental de Salud'),
(15, 'Selvasalud'),
(16, 'Colsanitas'),
(17, 'Saludvida'),
(18, 'Saludcoop'),
...
INSERT INTO tbl_estado_civil (IdEstCivil, Nombre) VALUES
(1, 'Soltero(a)'),
(2, 'Casado(a)'),
(3, 'Divorciado(a)'),
(4, 'Viudo(a)'),
...
INSERT INTO tbl_forma_ensenanza (IdFormaEnsenanza, NombreFormaEnsenanza) VALUES
(1, 'Back-riding'),
(2, 'Solo, con apoyo manual'),
(3, 'En la Cuerda'),
(4, 'Monta solo');

INSERT INTO tbl_generos (IdGenero, Nombre) VALUES
(1, 'Masculino'),
(2, 'Femenino');

INSERT INTO tbl_horario_laboral_profesional (IdHorarioLaboralPM, NombreHorarioLaboralPM) VALUES
(1, 'Mañana'),
(2, 'Tarde');

INSERT INTO tbl_departamento (iddepartamento, nombre) VALUES
(1, 'AMAZONAS'),
(2, 'ANTIOQUIA'),
(3, 'ARAUCA'),
(4, 'ATLÁNTICO'),
...
INSERT INTO tbl_municipio (idmunicipio, nombreMunicipio, departamento_iddepartamento) VALUES
(1, 'EL ENCANTO', 1),
(2, 'LA CHORRERA', 1),
(3, 'LA PEDRERA', 1),
(4, 'LA VICTORIA', 1),
...
INSERT INTO tbl_parentescos (IdParentesco, Nombre) VALUES
(1, 'Esposo(a)'),
(2, 'Padre'),
(3, 'Madre'),
(4, 'Hermano(a)'),
...
INSERT INTO tbl_usuarios (IdUsuario, TipoId, Nombre, Apellido1, Apellido2, Cargo, Usuario, Clave, Cambio_clave, Perfil, Estado) VALUES
('1000', 1, 'Administrador', 'Administrador', '', 1, 'admin', '4d0b24ccade22df6d154778cd66baf04288aae26df97a961f3ea3dd616fbe06dcebecc9bbe4ce93c8e12dca21e5935c08b0954534892c568b8c12b92f26a2448', 0, 1, 'Activo');