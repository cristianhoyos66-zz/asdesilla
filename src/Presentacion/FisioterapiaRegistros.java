...
/**
 * Esta clase permite pintar la ventana para la búsqueda de los registros de Fisioterapia
 * @author Cristian A. Hoyos Jaramillo
 * @author Daniela Estrada Monsalve
 * @author Yeisson A. Ochoa Villa
 */
public class FisioterapiaRegistros extends javax.swing.JFrame {
    DefaultTableModel dtm;
    Map<String, String> p;

    public FisioterapiaRegistros() {
        initComponents();
        ...
        try{
            ArrayList <Object[]> l = OpFisioterapia.obtenerRegistros();
    ...
    /**
     * Obtiene la información de la fisioterapia de acuerdo a los datos de la tabla
    ...
    private void btnDetallesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetallesActionPerformed
        try {
            ...
            Fisioterapia.jcPaciente.addItem(paciente);
            Fisioterapia.jcPaciente.setSelectedItem(paciente);
            
            String profesional = Registros.getValueAt(Registros.getSelectedRow(), 3).toString();
            
            OpFisioterapia.buscar(fecha, hc);
            Fisioterapia.txtNHC.setEnabled(false);
            Fisioterapia.txtNHC.setText(hc);
            Fisioterapia.FechaFisioterapia.setEnabled(false);
            Fisioterapia.FechaFisioterapia.setDate(formatoFecha.parse(fecha));
            Fisioterapia.jcPaciente.setEnabled(false);
            Fisioterapia.jcContrCefalico.setEnabled(false);
            Fisioterapia.jcContrCefalico.setSelectedItem(OpFisioterapia.getControlCefalico());
            Fisioterapia.jcRolados.setEnabled(false);
            Fisioterapia.jcRolados.setSelectedItem(OpFisioterapia.getRolados());
            Fisioterapia.jcArrastre.setEnabled(false);
            Fisioterapia.jcArrastre.setSelectedItem(OpFisioterapia.getArrastre());
            Fisioterapia.jcGateo.setEnabled(false);
            Fisioterapia.jcGateo.setSelectedItem(OpFisioterapia.getGateo());
            Fisioterapia.jcSedestesacion.setEnabled(false);
            Fisioterapia.jcSedestesacion.setSelectedItem(OpFisioterapia.getSedestesacion());
            Fisioterapia.jcBipedestacion.setEnabled(false);
            Fisioterapia.jcBipedestacion.setSelectedItem(OpFisioterapia.getBipedestacion());
            Fisioterapia.jcMarcha.setEnabled(false);
            Fisioterapia.jcMarcha.setSelectedItem(OpFisioterapia.getMarcha());
            Fisioterapia.jcApoyo.setEnabled(false);
            Fisioterapia.jcApoyo.setSelectedItem(OpFisioterapia.getApoyo());
            Fisioterapia.jcPartesCuerpo.setEnabled(false);
            Fisioterapia.jcPartesCuerpo.setSelectedItem(OpFisioterapia.getPartesCuerpo());
            Fisioterapia.txtDPartesCuerpo.setEnabled(false);
            Fisioterapia.txtDPartesCuerpo.setText(OpFisioterapia.getDPartesCuerpo());
            Fisioterapia.jcTonoMuscular.setEnabled(false);
            Fisioterapia.jcTonoMuscular.setSelectedItem(OpFisioterapia.getTonoMuscular());
            Fisioterapia.txtObservaciones.setEnabled(false);
            Fisioterapia.txtObservaciones.setText(OpFisioterapia.getObservaciones());
            Fisioterapia.jcProfesional.setEnabled(false);
            Fisioterapia.jcProfesional.addItem(profesional);
            Fisioterapia.jcProfesional.setSelectedItem(profesional);
            OpFisioterapia.setFecha("");
            OpFisioterapia.setIdHistoriaClinica("");
            OpFisioterapia.setControlCefalico("");
            OpFisioterapia.setRolados("");
            OpFisioterapia.setArrastre("");
            OpFisioterapia.setGateo("");
            OpFisioterapia.setSedestesacion("");
            OpFisioterapia.setBipedestacion("");
            OpFisioterapia.setMarcha("");
            OpFisioterapia.setApoyo("");
            OpFisioterapia.setPartesCuerpo("");
            OpFisioterapia.setDPartesCuerpo("");
            OpFisioterapia.setTonoMuscular("");
            OpFisioterapia.setObservaciones("");
            OpFisioterapia.setProfesional("");
            Fisioterapia.txtDocProf.setEnabled(false);
            Fisioterapia.btnBusquedaProf.setEnabled(false);
            Fisioterapia.txtDocPac.setEnabled(false);
            Fisioterapia.btnBusquedaPac.setEnabled(false);
            Fisioterapia.btnCrearFisioterapia.setEnabled(false);
    ...
    private void btnBusquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBusquedaActionPerformed
        if(txtDocPac.getText() == null || txtDocPac.getText().trim().isEmpty()){
            ...
            try {
                jcPaciente.removeAllItems();
                p = OpFisioterapia.consultarPacientes(txtDocPac.getText());
    ...
    //public static void main(String args[]) {
        ...
        /*try {
            ...
            java.util.logging.Logger.getLogger(FisioterapiaRegistros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    /**
     * Método que permite buscar un registro de una fisioterapia de acuerdo a la fecha y/o número de identificación digitada
    ...
    public void buscar() {
        ...
        if(fecha == null && id == null){
            ...
            l = OpFisioterapia.buscarRegistros(fecha, id);
            if(l.size()>0){
                btnDetalles.setEnabled(false);
                if(dtm.getRowCount()!=0){
                    for (int i = 0; i < dtm.getRowCount(); i++) {
